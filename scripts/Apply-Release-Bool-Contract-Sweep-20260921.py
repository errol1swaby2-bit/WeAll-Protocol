...
# This rehearsal reads JSON responses from public API surfaces. Missing or
# wrong-typed `ok` values must fail instead of inheriting Python truthiness.

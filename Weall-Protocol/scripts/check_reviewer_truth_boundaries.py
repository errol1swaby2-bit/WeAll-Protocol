#!/usr/bin/env python3
"""Check reviewer-facing docs for high-risk unbounded readiness claims.
...
def main() -> int:
    ...
    if findings:
        ...
        for finding in findings:
            print(finding)
        print("\nRewrite these lines with explicit truth boundaries before reviewer submission.")
        return 1

    print("[truth-boundary] OK: no high-risk unbounded reviewer readiness claims found")
    return 0

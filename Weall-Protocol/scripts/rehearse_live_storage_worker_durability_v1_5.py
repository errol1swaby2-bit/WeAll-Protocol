    ...
    with tempfile.TemporaryDirectory(prefix="weall-b542-storage-worker-") as td:
        ...
        for op in ["op-a", "op-b", "op-c"]:
            ...
            apply_storage(
                ...
                _env(
                    ...
                    op,
                    10 + len(op),
                    {"offer_id": f"offer-{op}", "operator_id": op, "capacity_bytes": 1024},
                ),
            )
        req = apply_storage(
            state,
        ...
        failure = apply_storage(
            ...
            _env(
                ...
                "SYSTEM",
                2,
                {"pin_id": "pin-live", "operator_id": failed_operator, "ok": False},
                system=True,
                parent="pin-live",
            ),
        )
        ...
        replacement = str(
            pin_after_failure.get("latest_reassignment", {}).get("new_operator_id") or replacement
        )
        ...
        confirm = apply_storage(
            ...
            _env(
                ...
                3,
                {
                    ...
                    "ok": True,
                    "retrieval_ok": reread_ok,
                    "retrieval_sha256": proof["sha256"],
                },
                system=True,
                parent="pin-live",
            ),
        ...
        return {
            ...
            and pin.get("durability_status") == "retrieval_confirmed",
            "batch": "542",

...
def build() -> Json:
    gates: list[Json] = [
        ...
        },
        {
            ...
            "capture_script": "scripts/capture_public_observer_open_download_transcript_v1_5.sh",
            "proof_template": "docs/proofs/public-observer-open-download/2026-07-05/TRANSCRIPT_TEMPLATE.md",
            "required_artifacts": [
                ...
                "docs/testnet/PUBLIC_OBSERVER_OPEN_DOWNLOAD_TRANSCRIPT.md",
                "docs/proofs/public-observer-open-download/2026-07-05/README.md",
                "docs/proofs/public-observer-open-download/2026-07-05/TRANSCRIPT_TEMPLATE.md",
            ],
        },
    ]
    payload: Json = {
        ...
        "verification_commands": [
            ...
            "PYTHONPATH=src python3 scripts/gen_crypto_posture_v1_5.py",

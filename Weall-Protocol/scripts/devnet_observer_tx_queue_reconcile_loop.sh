...
DEFAULT_RUNTIME_DIR="${WEALL_DEVNET_DIR:-${REPO_ROOT}/.weall-devnet}/runtime"
TX_QUEUE_PATH="${WEALL_TX_QUEUE_PATH:-${WEALL_RUNTIME_DIR:-${DEFAULT_RUNTIME_DIR}}/observer_tx_queue.json}"

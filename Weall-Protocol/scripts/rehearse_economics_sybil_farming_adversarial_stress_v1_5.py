...
from weall.runtime.apply.economics import (
    ...
    economics_locked_sybil_farming_adversarial_summary,
...
def run_harness() -> Json:
    ...
    return {
        "ok": stress["economics_enabled"] is False
        and stress["rejected_claim_count"] > stress["accepted_claim_count"]
        and stress["sybil_recipient_rejections"] > 0
        and treasury["public_accountability_report"] is True,

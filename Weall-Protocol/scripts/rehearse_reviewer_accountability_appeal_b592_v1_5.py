...
def run_harness() -> Json:
    ...
    decision = {
        "status": "confirmed",
        "panel": panel,
        "vote": {panel[0]: "confirm", panel[1]: "confirm", panel[2]: "dismiss"},
    }
    ...
    appeal = {
        "filed_by": "@a2",
        "new_evidence_hash": _h({"live_review": True}),
    ...
    recovery = {
        ...
        "case_reopened_for_monitoring": True,
    }
    deletion = {
        "restricted_identity_evidence_deleted": True,
        "retained_audit_hash": _h(suspicion),
        "raw_evidence_retained": False,
    }
    return {
        "ok": bool(
            panel
            and reviewers["@r4"]["conflicted"]
            and deletion["restricted_identity_evidence_deleted"]
            and recovery["restriction_removed"]
        ),
        "batch": "592",

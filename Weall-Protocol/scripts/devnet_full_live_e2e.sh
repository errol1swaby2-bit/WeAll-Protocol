...
export WEALL_DEVNET_RUN_TIER2="${WEALL_DEVNET_RUN_TIER2:-0}"
export WEALL_DEVNET_RUN_LIVE="${WEALL_DEVNET_RUN_LIVE:-1}"
export WEALL_LIVE_JUROR_COUNT="${WEALL_LIVE_JUROR_COUNT:-10}"

...
def run_harness() -> dict[str, Any]:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="weall-b557-peer-sync-") as td:
            ...
            req1 = StateSyncRequestMsg(
                header=_header(chain_id, corr_id="b557-a"),
                mode="delta",
                from_height=0,
                to_height=2,
            ...
            req2 = StateSyncRequestMsg(
                header=_header(chain_id, corr_id="b557-b"),
                mode="delta",
                from_height=2,
                to_height=height,
                selector={"trusted_anchor": anchor},
            ...
            resume_req = StateSyncRequestMsg(
                header=_header(chain_id, corr_id="b557-resume"),
                mode="delta",
            ...
            wrong_req = StateSyncRequestMsg(
                header=_header("wrong-chain", corr_id="b557-wrong"),
                mode="delta",
                from_height=0,
                to_height=height,
                selector={"trusted_anchor": anchor},
            ...
            return {
                "ok": bool(
                    ...
                    and all(second_results)
                    and source_root == fresh_root
                    and corrupt_rejected
                    and wrong_chain_rejected
                ),
                "batch": "557",

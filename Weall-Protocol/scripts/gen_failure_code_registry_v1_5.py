...
STATIC_LAUNCH_CODES = [
    ...
    "SIGNATURE_PROFILE_NOT_ALLOWED",
    "SIGNATURE_PROFILE_VERIFIER_UNAVAILABLE",
    "CLASSICAL_SIGNATURE_PROFILE_REMOVED",
    "MLDSA_VERIFIER_UNAVAILABLE",
    "PQ_SEED_REGISTRY_RESIGN_REQUIRED",
]

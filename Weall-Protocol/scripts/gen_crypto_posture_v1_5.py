...
CRYPTO_INVENTORY: list[Json] = [
    ...
    {"surface":"helper_receipts_certificates","current_algorithm":"production helper execution remains disabled; helper receipt/certificate signing has legacy Ed25519/HMAC compatibility and must not be used as public authority until PQ-gated","target_algorithm":"pq-mldsa-v1 helper receipt/certificate profile before production helper enablement","consensus_critical":True,"account_custody":False,"observer_trust":True,"transport_or_local_only":False,"upgrade_before_closed_testnet":False,"upgrade_before_public_testnet":True,"external_audit_before_mainnet":True},
...
def build_readiness() -> Json:
    ...
    blockers.extend([
        ...
        "helper_receipt_certificate_production_pq_gate_missing",

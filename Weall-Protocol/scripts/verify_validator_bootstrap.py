...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify local validator bootstrap invariants against tx index, protocol profile, DB state, and optional trusted anchor or bundle."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--bundle",
        default=None,
        help="Optional path to a bootstrap bundle JSON generated by build_validator_bootstrap_bundle.py.",
    )
    parser.add_argument(
        "--release-pubkey",
        default=None,
    ...
    try:
        ...
        report = {
            "ok": False,
            "issues": [f"failed to read db state: {exc}"],
            "db_path": str(db_path),
        }
    ...
    report = {
        ...
        "db_meta": {
            ...
            "production_consensus_profile_hash": str(
                meta.get("production_consensus_profile_hash") or ""
            ),

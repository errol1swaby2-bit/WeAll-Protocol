...
def fixture_states() -> list[Json]:
    ...
    return [
        ...
        {
            "name": "with_ephemeral_fields_same_semantics",
            "state": with_ephemeral,
            "same_root_as": "base",
        },
        {
            "name": "consensus_meta_policy_is_root_bound",
            "state": consensus_meta_changed,
            "different_root_from": "base",
        },
        {"name": "nested_meta_reference", "state": nested_meta_reference},
        {
            "name": "nested_meta_semantic_change",
            "state": nested_meta_changed,
            "different_root_from": "nested_meta_reference",
        },
        {"name": "list_order_reference", "state": list_order_reference},
        {
            "name": "list_order_changed",
            "state": list_order_changed,
            "different_root_from": "list_order_reference",
        },
...
def build_payload() -> Json:
    ...
    return {
        ...
        "assertions": [
            ...
            {
                "kind": "not_equal",
                "left": "nested_meta_reference",
                "right": "nested_meta_semantic_change",
            },

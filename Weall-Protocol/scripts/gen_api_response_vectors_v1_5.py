...
_VECTOR_ROUTES: list[Json] = [
    ...
    },
    {
        ...
        "auth_case": "public_read_redacted_snapshot",
        "error_codes": [],
        "privacy_boundary": "mempool size/diagnostics are visible but pending private payloads stay bounded/redacted",
    },
    {
    ...
    {
        "id": "poh-tier2-request-signed-account",
        "method": "POST",
        "path": "/v1/poh/tier2/tx/request",
        "route_key": "POST /v1/poh/tier2/tx/request",
        "expected_http_statuses": [200, 400, 403, 422],
        "expected_error_envelope": {"ok": False, "error": {"code": "invalid_tx"}},
        "auth_case": "signed_account_tx_required",
        "error_codes": ["invalid_tx", "signature_required", "signature_invalid", "session_required"],
        "privacy_boundary": "tier-2 request does not imply reviewer or validator responsibility",
    },
    {
        "id": "poh-tier2-review-lane-bound",
        "method": "POST",
        "path": "/v1/poh/tier2/tx/review",
        "route_key": "POST /v1/poh/tier2/tx/review",
        "expected_http_statuses": [200, 400, 403, 422],
        "expected_error_envelope": {"ok": False, "error": {"code": "reviewer_responsibility_not_active"}},
        "auth_case": "signed_reviewer_lane_tx_required",
        "error_codes": ["reviewer_responsibility_not_active", "invalid_tx", "signature_required"],
        "privacy_boundary": "tier-2 review is only valid for exact active PoH reviewer/juror lanes",
    },
    {

...
def run_harness() -> dict[str, Any]:
    ...
    _seed_case(
        state,
        case_id="case-window-reverified",
        subject="@subject",
        reviewers=reviewers,
    ...
    return {
        "ok": bool(
            ...
            and int(suspicion.get("review_window_close_height") or 0)
            > int(suspicion.get("review_window_open_height") or 0)
            and int(suspicion.get("recovery_eligible_after_height") or 0)
            == int(suspicion.get("review_window_close_height") or 0)

...
pytest -q tests/test_helper_serial_equivalence_fallback.py tests/test_helper_fallback_equivalence.py tests/test_helper_execution_root_commitment.py tests/test_mempool_clears_only_committed_txs.py tests/test_pending_tx_survives_failed_commit.py
...
pytest -q tests/test_block_candidate_selection_is_deterministic.py tests/test_block_id_is_stable_for_same_candidate_inputs.py tests/test_block_commitments_required.py tests/test_block_timestamp_validation_received.py tests/test_config_fail_closed.py tests/test_production_consensus_profile.py tests/test_node_lifecycle_production_preflight.py tests/test_mixed_node_posture_fail_closed.py tests/test_priority1_replay_equivalence.py tests/test_priority2_state_replay_determinism.py
```

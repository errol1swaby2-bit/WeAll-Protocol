...
- **539**: production BFT artifact path rehearsal through `WeAllExecutor.bft_leader_propose`, `bft_make_vote_for_block`, `bft_handle_vote`, and production block commit/replay surfaces. The old `__batch534` proof endpoints are not used.

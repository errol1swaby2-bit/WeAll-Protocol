...
- **534** — Full node-process controlled validator rehearsal using FastAPI/Uvicorn subprocesses, real localhost ports, readyz probes, vote/commit/sync rehearsal endpoints, restart, rejoin, observer rejection, and matching roots.

...
WeAll's primary human-verification path must be protocol-native. It must not require email, SMTP, DNS, named hosting providers, CAPTCHA, OAuth, KYC vendors, government ID, or inbox control.

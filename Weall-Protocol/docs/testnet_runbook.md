...
- native async/live PoH onboarding is the documented and testable path through `scripts/devnet_controlled_readiness_suite.sh` and `scripts/devnet_full_onboarding_e2e.sh`

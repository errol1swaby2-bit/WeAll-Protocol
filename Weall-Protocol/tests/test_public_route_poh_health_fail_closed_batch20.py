...
def test_health_invalid_net_enabled_env_fails_closed_in_prod(
...
def test_health_invalid_readyz_require_block_loop_env_breaks_readyz_in_prod(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv("WEALL_MODE", "prod")
...
def test_poh_invalid_tier2_video_max_bytes_env_fails_closed_in_prod(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv("WEALL_MODE", "prod")
...
def test_poh_invalid_enable_operator_poh_env_fails_closed_in_prod(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv("WEALL_MODE", "prod")

...
def test_local_rehearsal_waits_for_frontend_shell_not_only_backend_proxy_batch402() -> None:
...
def test_local_rehearsal_frontend_ports_are_strict_batch402() -> None:
    src = _read(ROOT / "scripts" / "devnet_local_two_frontend_rehearsal.sh")

...
def test_media_partial_replication_not_durable():
    """
    If replication confirmations are below replication_factor,
    the object must not be marked durable.
    """
    ...
    assert int(body["ok_unique_ops"]) == 1

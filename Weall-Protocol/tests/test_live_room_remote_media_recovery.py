...
def test_webrtc_track_without_stream_is_materialized_batch453() -> None:
...
def test_live_room_queues_ice_and_retries_missing_remote_media_batch453() -> None:
...
def test_live_room_targets_hello_and_surfaces_peer_state_batch453() -> None:
    src = _read(WEB / "src/pages/LiveVerificationRoom.tsx")
...
def test_live_room_signal_handling_is_duplicate_and_glare_tolerant_batch453() -> None:
    src = _read(WEB / "src/pages/LiveVerificationRoom.tsx")

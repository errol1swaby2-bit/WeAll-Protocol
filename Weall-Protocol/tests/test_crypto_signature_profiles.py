...
def test_closed_testnet_default_allows_pq_and_rejects_legacy_without_chain_allowlist(monkeypatch):
    monkeypatch.setenv("WEALL_CRYPTO_MODE", "closed-testnet")
...
def test_explicit_chain_allowlist_can_exercise_legacy_migration_only(monkeypatch):
    monkeypatch.setenv("WEALL_CRYPTO_MODE", "closed-testnet")

...
def _state() -> dict:
    return {
        ...
        "content": {
            "posts": {"post-1": {"author": "alice", "visibility": "public"}},
            "comments": {},
        },
    }
...
def test_dispute_open_and_assignment_record_block_height_phase_markers() -> None:
    ...
    apply_dispute(
        ...
        _env(
            ...
            "SYSTEM",
            1,
            {"dispute_id": "d-height", "juror": "juror"},
            system=True,
            parent="tx:alice:1",
        ),
    )
...
def test_dispute_acceptance_deadlines_are_block_height_based() -> None:
    ...
    apply_dispute(
        ...
        _env(
            ...
            "SYSTEM",
            1,
            {"dispute_id": "d-window", "juror": "juror"},
            system=True,
            parent="tx:alice:1",
        ),
    )
    ...
    state["height"] = 31
    out = (
        apply_dispute(state, _env("DISPUTE_JUROR_ACCEPT", "juror", 2, {"dispute_id": "d-window"}))
        or {}
    )

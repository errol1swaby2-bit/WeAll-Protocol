...
def test_controlled_devnet_does_not_enable_open_bootstrap_for_rehearsal_batch603() -> None:
...
def test_live_reviewer_setup_is_genesis_bound_not_runtime_self_grant_batch603() -> None:
...
def test_full_onboarding_uses_genesis_reviewer_and_partial_live_panel_batch603() -> None:
...
def test_modified_rehearsal_scripts_are_syntax_valid_batch603() -> None:
    for rel in [

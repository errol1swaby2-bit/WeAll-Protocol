...
def test_domain_dispatch_rejects_noncanonical_unknown_tx_type() -> None:
...
def test_helper_planner_order_no_longer_depends_on_received_ms() -> None:
    txs = [
...
def test_mempool_canonical_fetch_uses_canonical_sql_order_before_limit(tmp_path: Path) -> None:

...
def test_webrtc_page_surfaces_live_voting_inside_video_room_batch408() -> None:
...
def test_webrtc_voting_copy_keeps_video_transport_non_authoritative_batch408() -> None:
    src = (WEB / "src" / "pages" / "LiveVerificationRoom.tsx").read_text(encoding="utf-8")

...
def test_prod_bootstrap_requires_explicit_peer_id(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_prod_bootstrap_rejects_disabled_peer_identity(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_rejects_disabled_sync_header_match(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_rejects_disabled_finalized_anchor_for_bft(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_requires_bft_fetch_sources(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_rejects_non_https_bft_fetch_sources(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_rejects_disabled_bft_fetch(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_network_happy_path_with_explicit_fetch_sources(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
    assert production_bootstrap_issues(_cfg(tmp_path)) == []


def test_prod_bootstrap_rejects_disabled_handshake_identity_requirement(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)
...
def test_prod_bootstrap_rejects_disabled_bft_identity_requirement(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    _set_prod_network_env(monkeypatch)

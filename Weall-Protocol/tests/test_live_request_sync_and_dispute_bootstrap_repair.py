...
def test_live_request_waits_for_confirmed_synced_case_before_routing_batch394b() -> None:
...
def test_dispute_frontend_has_bootstrap_single_reviewer_fallback_batch394b() -> None:
...
def test_dispute_accept_materializes_committed_bootstrap_eligible_record_batch394b() -> None:
    src = _read(NESTED / "src" / "weall" / "runtime" / "apply" / "dispute.py")

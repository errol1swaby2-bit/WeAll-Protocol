...
def test_duplicate_node_key_blocks_all_matching_accounts() -> None:
...
def test_duplicate_node_key_blocks_production_preflight_even_if_legacy_active() -> None:
...
def test_operator_status_api_exposes_centralized_responsibility_truth() -> None:
...
def test_frontend_uses_operator_status_api_instead_of_only_raw_role_inference() -> None:

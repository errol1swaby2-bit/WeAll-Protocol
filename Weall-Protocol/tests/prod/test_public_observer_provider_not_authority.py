...
def test_nodes_seeds_reports_provider_authority_false_for_generic_mirror(
        ...
        json.dumps(
            {
                ...
                "seed_registry_mirrors": [
                    {"url": "https://mirror.example.org/registry.json", "provider": "custom"}
                ],
                "seed_registry_urls": [],
            }
        ),
    ...
    monkeypatch.setattr(
        public_seed_registry, "_http_get_registry_json", lambda _url, *, timeout_s: registry
    )

...
def test_legal_compliance_pack_documents_non_claim_boundary() -> None:
    evidence_pack = (ROOT / "docs" / "legal" / "COUNSEL_REVIEW_EVIDENCE_PACK.md").read_text(
        encoding="utf-8"
    )
    runbook = (ROOT / "docs" / "testnet" / "LEGAL_COMPLIANCE_EVIDENCE_PACK.md").read_text(
        encoding="utf-8"
    )
    status = (ROOT / "docs" / "reviewer" / "PUBLIC_BETA_BLOCKER_STATUS.md").read_text(
        encoding="utf-8"
    )

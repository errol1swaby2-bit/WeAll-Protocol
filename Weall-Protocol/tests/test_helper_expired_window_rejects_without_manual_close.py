...
def test_helper_store_rejects_expired_window_without_manual_close_batch35() -> None:
    ...
    status = store.ingest_certificate(cert=cert, peer_id=lane_plan.helper_id, now_ms=1050)

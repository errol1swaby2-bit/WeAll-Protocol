...
_EVENT_SPECS: tuple[ReputationEventSpec, ...] = (
    ...
    _spec(
        ...
        False,
        "none",
        "supports_poh_reviewer_eligibility",
        "Tier 1 humanity verification completed.",
    ),
    _spec(
        "POH_TIER2_APPROVED",
        "poh",
        ...
        True,
        "none",
        "supports_civic_and_review_eligibility",
        "Tier 2 async humanity review approved.",
    ),
    _spec(
        "POH_TIER3_APPROVED",
        "poh",
        ...
        True,
        "none",
        "supports_live_review_eligibility",
        "Tier 3 live humanity verification approved.",
    ),
    _spec(
        "POH_REVERIFICATION_COMPLETED",
        "poh",
        "poh_reputation",
        500,
        1,
        True,
        "none",
        "restores_or_preserves_poh_eligibility",
        "Humanity reverification completed.",
    ),
    _spec(
        "POH_DUPLICATE_ATTEMPT",
        "poh",
        "poh_reputation",
        -2500,
        4,
        True,
        "none",
        "blocks_or_suspends_poh_eligibility",
        "Duplicate humanity attempt detected.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "POH_FRAUDULENT_EVIDENCE",
        "poh",
        "poh_reputation",
        -10000,
        5,
        True,
        "none",
        "disqualifies_poh_review_and_may_revoke_humanity",
        "Fraudulent humanity evidence confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "POH_LIVENESS_FAILURE_AFTER_ACCEPTED_REVIEW",
        "poh",
        "poh_reputation",
        -750,
        2,
        True,
        "recoverable_after_reverification",
        "temporarily_limits_poh_review_eligibility",
        "Accepted reviewer missed required PoH liveness obligation.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "POH_REVOKED_BY_FINAL_DISPUTE",
        "poh",
        "poh_reputation",
        -100000,
        5,
        True,
        "none",
        "revokes_poh_eligibility",
        "Final dispute revoked PoH status.",
        can_trigger_ineligibility=True,
    ),
    # Juror/dispute
    _spec(
        ...
        False,
        "none",
        "creates_review_obligation",
        "Juror accepted a dispute assignment.",
    ),
    _spec(
        ...
        False,
        "none",
        "slot_released_no_penalty",
        "Juror withdrew within the no-penalty window.",
    ),
    _spec(
        ...
        1,
        True,
        "recoverable_by_timely_reviews",
        "light_juror_reliability_penalty",
        "Juror withdrew after the no-penalty window.",
        can_trigger_ineligibility=False,
    ),
    _spec(
        ...
        True,
        "recoverable_by_timely_reviews",
        "juror_assignment_risk",
        "Juror missed the canonical review deadline.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        ...
        1,
        False,
        "positive_cap_per_epoch",
        "supports_juror_eligibility",
        "Juror voted before the canonical review deadline.",
        farming_policy="cap_positive_dispute_participation_per_epoch",
    ),
    _spec(
        "JUROR_ACCEPTED_AND_COMPLETED_CASE",
        "dispute",
        "juror_reputation",
        250,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_juror_eligibility",
        "Juror completed an accepted case.",
        farming_policy="cap_positive_dispute_participation_per_epoch",
    ),
    _spec(
        "JUROR_VOTED_BEFORE_DEADLINE",
        "dispute",
        "juror_reputation",
        250,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_juror_eligibility",
        "Juror submitted a vote before deadline.",
        farming_policy="cap_positive_dispute_participation_per_epoch",
    ),
    _spec(
        "JUROR_PROVIDED_REQUIRED_REASONING",
        "dispute",
        "juror_reputation",
        100,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_juror_eligibility",
        "Juror provided required reasoning.",
    ),
    _spec(
        "JUROR_PARTICIPATED_IN_APPEAL_REVIEW",
        "appeal",
        "juror_reputation",
        150,
        1,
        False,
        "positive_cap_per_epoch",
        "supports_appeal_panel_eligibility",
        "Juror participated in appeal review.",
    ),
    _spec(
        "JUROR_TIMEOUT",
        "dispute",
    ...
    _spec(
        "JUROR_CONFLICT_OF_INTEREST_VIOLATION",
        "dispute",
        "juror_reputation",
        -5000,
        4,
        True,
        "none",
        "blocks_juror_eligibility",
        "Juror conflict of interest violation confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "JUROR_ABUSIVE_REASONING",
        "dispute",
        "juror_reputation",
        -2500,
        3,
        True,
        "none",
        "limits_juror_eligibility",
        "Juror reasoning violated safety rules.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "JUROR_PATTERN_OF_BAD_FAITH_VOTES",
        "dispute",
        "juror_reputation",
        -5000,
        4,
        ...
        "none",
        "blocks_juror_eligibility",
        "Pattern of bad-faith juror votes confirmed; disagreement alone is never penalized.",
        can_trigger_ineligibility=True,
    ),
    # Governance
    _spec(
        ...
        False,
        "positive_cap_per_epoch",
        "supports_governance_eligibility",
        "Governance vote submitted.",
    ),
    _spec(
        "GOVERNANCE_COMMENTED_DURING_DELIBERATION",
        "governance",
        "governance_reputation",
        50,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_governance_eligibility",
        "Comment made during deliberation.",
    ),
    _spec(
        "GOVERNANCE_CREATED_VALID_PROPOSAL",
        "governance",
        "governance_reputation",
        150,
        1,
        True,
        "positive_cap_per_epoch",
        "supports_proposal_eligibility",
        "Valid governance proposal created.",
    ),
    _spec(
        "GOVERNANCE_PROPOSAL_PASSED_WITHOUT_SAFETY_ISSUE",
        "governance",
        "governance_reputation",
        250,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_proposal_eligibility",
        "Proposal passed without a safety issue.",
    ),
    _spec(
        "GOVERNANCE_SPAM_PROPOSAL",
        "governance",
        "governance_reputation",
        -1000,
        2,
        True,
        "recoverable_by_valid_participation",
        "limits_proposal_creation",
        "Governance spam proposal confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "GOVERNANCE_MALFORMED_UPGRADE_PATCH",
        "governance",
        "governance_reputation",
        -2500,
        3,
        True,
        "none",
        "blocks_upgrade_submission",
        "Malformed or unsafe upgrade patch submitted.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "GOVERNANCE_DUPLICATE_OR_ABUSIVE_PROPOSAL",
        "governance",
        "governance_reputation",
        -1500,
        2,
        ...
        "recoverable_by_valid_participation",
        "limits_proposal_creation",
        "Duplicate or abusive governance proposal confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "GOVERNANCE_CONFIRMED_BRIBERY_OR_COLLUSION",
        "governance",
        "governance_reputation",
        -10000,
        5,
        True,
        "none",
        "disqualifies_governance_roles",
        "Governance bribery or collusion confirmed.",
        can_trigger_ineligibility=True,
    ),
    # Creator/social/content
    _spec(
        "CREATOR_POST_UPHELD_AFTER_REPORT",
        "content",
        "creator_reputation",
        250,
        1,
        True,
        "positive_cap_per_epoch",
        "supports_creator_trust",
        "Creator post was upheld after report review.",
    ),
    _spec(
        "CREATOR_HELPFUL_CONTRIBUTION",
        "content",
        "creator_reputation",
        100,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_feed_trust",
        "Helpful creator contribution recorded.",
        farming_policy="cap_positive_creator_events_per_epoch",
    ),
    _spec(
        "CREATOR_GROUP_CONTRIBUTION",
        "groups",
        "creator_reputation",
        100,
        1,
        True,
        "positive_cap_per_epoch",
        "supports_group_trust",
        "Helpful group contribution recorded.",
    ),
    _spec(
        "CREATOR_EDUCATIONAL_CONTENT",
        "content",
        "creator_reputation",
        150,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_feed_trust",
        "Educational content contribution recorded.",
    ),
    _spec(
        ...
        3,
        True,
        "recoverable_after_clean_participation",
        "limits_creator_and_feed_trust",
    ...
    _spec(
        ...
        True,
        "none",
        "limits_or_blocks_creator_trust",
        "Content harassment confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        ...
        "none",
        "limits_feed_trust",
        "Content manipulation confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "CONTENT_EVASION_AFTER_MODERATION",
        "moderation",
        "creator_reputation",
        -5000,
        4,
        True,
        "none",
        "blocks_creator_trust",
        "Evasion after moderation confirmed.",
        can_trigger_ineligibility=True,
    ),
    # Safety/moderation/reporting
    _spec(
        "SAFETY_ACCURATE_REPORT",
        "moderation",
        "safety_reputation",
        150,
        1,
        True,
        "positive_cap_per_epoch",
        "supports_safety_role_eligibility",
        "Accurate report confirmed.",
    ),
    _spec(
        "SAFETY_FALSE_OR_ABUSIVE_REPORT",
        "moderation",
        "safety_reputation",
        -1500,
        3,
        True,
        "recoverable_after_clean_participation",
        "limits_safety_role_eligibility",
        "False or abusive report confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "SAFETY_CONFIRMED_MODERATION_ACTION",
        "moderation",
        "safety_reputation",
        150,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_safety_role_eligibility",
        "Moderation action confirmed.",
    ),
    _spec(
        "SAFETY_REVERSED_MODERATION_ACTION",
        "appeal",
        "safety_reputation",
        -1000,
        2,
        ...
        "recoverable_after_clean_participation",
        "limits_safety_role_eligibility",
        "Moderation action reversed on appeal.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "SAFETY_FRIVOLOUS_APPEAL_PATTERN",
        "appeal",
        "safety_reputation",
        -1000,
        2,
        True,
        "recoverable_after_clean_participation",
        "limits_appeal_submission_trust",
        "Frivolous appeal pattern confirmed.",
        can_trigger_ineligibility=True,
    ),
    # Validator/operator
    _spec(
        "VALIDATOR_SIGNED_VALID_BLOCK",
        "validator",
        "validator_reputation",
        50,
        1,
        False,
        "positive_cap_per_epoch",
        "supports_validator_readiness",
        "Validator signed a valid block.",
    ),
    _spec(
        "VALIDATOR_MAINTAINED_UPTIME",
        "validator",
        "validator_reputation",
        100,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_validator_readiness",
        "Validator maintained uptime.",
    ),
    _spec(
        "VALIDATOR_PASSED_REHEARSAL",
        "validator",
        "validator_reputation",
        250,
        1,
        ...
        "none",
        "supports_validator_readiness",
        "Validator passed rehearsal.",
    ),
    _spec(
        "VALIDATOR_COMPLETED_VERSION_UPGRADE",
        "validator",
        "validator_reputation",
        150,
        1,
        ...
        "none",
        "supports_validator_readiness",
        "Validator completed version upgrade.",
    ),
    _spec(
        "VALIDATOR_DOWNTIME",
        "validator",
        ...
        2,
        True,
        "recoverable_by_uptime",
        "limits_validator_readiness",
        "Validator downtime confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        ...
        True,
        "none",
        "disqualifies_validator",
        "Validator double-signing confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "VALIDATOR_INVALID_BLOCK",
        "validator",
        "validator_reputation",
        -10000,
        5,
        True,
        "none",
        "disqualifies_or_suspends_validator",
        "Validator invalid block confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "VALIDATOR_STATE_DIVERGENCE",
        "validator",
        "validator_reputation",
        -25000,
        5,
        True,
        "none",
        "disqualifies_validator_until_review",
        "Validator state divergence confirmed.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "VALIDATOR_UNSAFE_VERSION",
        "validator",
        "validator_reputation",
        -2500,
        3,
        True,
        "recoverable_by_upgrade",
        "blocks_validator_until_upgrade",
        "Validator unsafe version detected.",
        can_trigger_ineligibility=True,
    ),
    # Storage/IPFS
    _spec(
        "STORAGE_PIN_CONFIRMED",
        "storage",
        "storage_reputation",
        100,
        1,
        False,
        "positive_cap_per_epoch",
        "supports_storage_assignment",
        "Storage pin confirmed.",
    ),
    _spec(
        "STORAGE_REVALIDATION_PASSED",
        "storage",
        "storage_reputation",
        150,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_storage_assignment",
        "Storage revalidation passed.",
    ),
    _spec(
        "STORAGE_SERVED_REQUIRED_CONTENT",
        "storage",
        "storage_reputation",
        100,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_storage_assignment",
        "Required content served.",
    ),
    _spec(
        "STORAGE_MISSING_REQUIRED_CONTENT",
        "storage",
        "storage_reputation",
        -1500,
        3,
        True,
        "recoverable_by_revalidation",
        "limits_storage_assignment",
        "Required content missing.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "STORAGE_FAILED_REVALIDATION",
        "storage",
        "storage_reputation",
        -1000,
        2,
    ...
    _spec(
        ...
        True,
        "none",
        "blocks_storage_assignment",
        "False storage availability claim confirmed.",
        can_trigger_ineligibility=True,
    ),
    # Helper/execution
    _spec(
        "HELPER_VALID_RECEIPT",
        "helper",
        "helper_reputation",
        100,
        1,
        False,
        "positive_cap_per_epoch",
        "supports_helper_assignment",
        "Helper submitted a valid receipt.",
    ),
    _spec(
        "HELPER_TIMELY_EXECUTION",
        "helper",
        "helper_reputation",
        100,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_helper_assignment",
        "Helper execution was timely.",
    ),
    _spec(
        "HELPER_SERIAL_EQUIVALENCE_CONFIRMED",
        "helper",
        "helper_reputation",
        150,
        1,
        ...
        "positive_cap_per_epoch",
        "supports_helper_assignment",
        "Helper result matched serial execution.",
    ),
    _spec(
        "HELPER_MALFORMED_RECEIPT",
        "helper",
        "helper_reputation",
        -1000,
        2,
        True,
        "recoverable_by_valid_receipts",
        "limits_helper_assignment",
        "Malformed helper receipt rejected.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "HELPER_CONTEXT_MISMATCH",
        "helper",
        "helper_reputation",
        -2500,
        3,
        True,
        "none",
        "blocks_helper_assignment_until_review",
        "Helper receipt context mismatch rejected.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        "HELPER_NONDETERMINISTIC_OUTPUT",
        "helper",
        "helper_reputation",
        -10000,
        5,
        ...
        "none",
        "disqualifies_helper",
        "Nondeterministic helper output rejected.",
        can_trigger_ineligibility=True,
    ),
    _spec(
        ...
        "none",
        "blocks_helper_assignment_until_review",
        "Helper receipt replay attempt rejected.",
        can_trigger_ineligibility=True,
    ),
    # Appeals/corrections
    _spec(
        ...
        False,
        "none",
        "reversal_history_only",
        "A reputation event was reversed by an append-only correction.",
    ),
    _spec(
        "APPEAL_ACCEPTED",
        "appeal",
    ...
    _spec(
        ...
        False,
        "none",
        "records_rejected_appeal",
        "Appeal rejected.",
    ),
    _spec(
        "APPEAL_REPUTATION_RESTORED",
        "appeal",
        "appeal_correction_history",
        0,
        0,
        False,
        "none",
        "restores_dimension_score_by_reversal_event",
        "Appeal restored reputation through a reversal event.",
    ),
    _spec(
        "APPEAL_FRIVOLOUS_PATTERN_CONFIRMED",
        "appeal",
        "appeal_correction_history",
        -1000,
        2,
    ...
    *,
    ...
    event = append_reputation_event(
        ...
        details={
            ...
            "appeal_actor_id": actor_id or original_actor,
            **dict(details or {}),
        },
    )
    return event
...
def canonical_reputation_events(state: Json) -> list[Json]:
    ...
    events.sort(
        key=lambda ev: (_as_int(ev.get("occurred_at_block"), 0), _as_str(ev.get("event_id")))
    )
    return events
...
def canonical_reputation_events_for_actor(state: Json, actor_id: str) -> list[Json]:
    return [
        event
        for event in canonical_reputation_events(state)
        if _matches_actor(event.get("actor_id"), actor_id)
    ]
...
def reduce_reputation_events(events: Iterable[Mapping[str, Any]]) -> Json:
    ...
    for ev in history:
        ...
        if (
            code in {"REPUTATION_EVENT_REVERSED", "APPEAL_ACCEPTED", "APPEAL_REPUTATION_RESTORED"}
            and dimension != "appeal_correction_history"
        ):
            ...
            appeal_cur["neutral_event_count"] = (
                _as_int(appeal_cur.get("neutral_event_count"), 0) + 1
            )
...
def derive_role_eligibility_from_dimensions(
...
def reputation_api_endpoints() -> list[Json]:
    routes = [
        ...
        (
            "GET",
            "/v1/reputation/{actor_id}",
            "public_read_redacted_snapshot",
            "public_matrix_summary",
        ),
        (
            "GET",
            "/v1/reputation/{actor_id}/events",
            "public_read_redacted_snapshot",
            "public_or_owner_events",
        ),
        (
            "GET",
            "/v1/reputation/{actor_id}/matrix",
            "public_read_redacted_snapshot",
            "public_or_owner_matrix",
        ),
        (
            "GET",
            "/v1/reputation/{actor_id}/eligibility",
            "public_read_redacted_snapshot",
            "role_eligibility_reasons",
        ),

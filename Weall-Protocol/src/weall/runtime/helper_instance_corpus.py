...
def build_default_helper_instance_corpus() -> list[Json]:
    ...
    return [
        ...
        {
            "tx_type": "POH_APPLICATION_SUBMIT",
            "payload": {"account_id": "@alice", "application_id": "app-001"},
        },
        {
            "tx_type": "CONTENT_POST_CREATE",
            "payload": {"account_id": "@alice", "post_id": "post-001"},
        },
        {
            "tx_type": "CONTENT_MEDIA_DECLARE",
            "payload": {"account_id": "@alice", "post_id": "post-001", "media_id": "media-001"},
        },
        {
            "tx_type": "CONTENT_COMMENT_CREATE",
            "payload": {"account_id": "@alice", "post_id": "post-001", "comment_id": "comment-001"},
        },
        {
            "tx_type": "NOTIFICATION_SUBSCRIBE",
            "payload": {"account_id": "@alice", "topic_id": "topic-news"},
        },
        {
        ...
        {
            "tx_type": "STORAGE_OFFER_CREATE",
            "payload": {"lease_id": "offer-001", "provider_id": "@alice"},
        },
        {
            "tx_type": "STORAGE_LEASE_CREATE",
            "payload": {"lease_id": "lease-001", "provider_id": "@alice"},
        },
        {

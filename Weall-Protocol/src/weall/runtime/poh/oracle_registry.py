...
ORACLE_TYPE_POH_ASYNC_TIER2 = "poh_async_tier2"
ORACLE_TYPE_POH_LIVE_TIER3 = "poh_live_tier3"

VALID_ORACLE_TYPES: frozenset[str] = frozenset(
    {ORACLE_TYPE_POH_EMAIL_TIER1, ORACLE_TYPE_POH_ASYNC_TIER2, ORACLE_TYPE_POH_LIVE_TIER3}
)

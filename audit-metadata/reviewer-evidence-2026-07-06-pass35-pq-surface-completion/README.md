...
This supplement closes the Pass 34 implementation gaps found in account session-login proofs and helper receipt/certificate signing surfaces. It keeps browser-local ML-DSA as legacy/dev-only and keeps production helper execution separately disabled.

...
// Dev CSP must allow Vite's inline preamble (and sometimes eval for tooling).
// Production/preview should remain strict and should ideally be enforced by headers at the edge.
const DEV_CSP =

...
if (exists('src/lib/' + 'message' + 'Crypto.ts')) throw new Error('removed cryptographic messaging module returned');
if (exists('src/pages/' + 'Mess' + 'aging.tsx')) throw new Error('removed messaging page returned');
